...
{
    /// <summary>
    /// 添加 assignments_json 字段到 ff_questionnaire 表
    /// </summary>
    public class Migration_20250101000004_AddQuestionnaireAssignmentsJsonColumn
    {
        public static void Up(ISqlSugarClient db)
        {
            try
            {
                ...
                if (!assignmentsJsonExists)
                {
                    ...
                    Console.WriteLine("✅ 已添加 assignments_json 字段到 ff_questionnaire 表");
                }
                else
                {
