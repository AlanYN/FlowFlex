...
/// <summary>
/// Migration to create Dynamic Data tables (EAV pattern)
/// </summary>
public static class CreateDynamicDataTables_20251226000001
{
    public static void Up(ISqlSugarClient db)
    {
        // Create Business Data Table
        var createBusinessDataTable = @"
        ...
        ";
        db.Ado.ExecuteCommand(createBusinessDataTable);

        // Create Data Value Table (EAV pattern)
        var createDataValueTable = @"
        ...
        ";
        db.Ado.ExecuteCommand(createDataValueTable);

        // Create Define Field Table
        var createDefineFieldTable = @"
        ...
        ";
        db.Ado.ExecuteCommand(createDefineFieldTable);

        // Create Field Group Table
        var createFieldGroupTable = @"
        ...
        ";
        db.Ado.ExecuteCommand(createFieldGroupTable);
        ...
        ";
        db.Ado.ExecuteCommand(addComments);
    }

    public static void Down(ISqlSugarClient db)
    {
        db.Ado.ExecuteCommand("DROP TABLE IF EXISTS ff_data_value CASCADE;");
        db.Ado.ExecuteCommand("DROP TABLE IF EXISTS ff_business_data CASCADE;");
        db.Ado.ExecuteCommand("DROP TABLE IF EXISTS ff_define_field CASCADE;");
        db.Ado.ExecuteCommand("DROP TABLE IF EXISTS ff_field_group CASCADE;");
    }
}
