    ...
    public class StageMapProfile : Profile
    {
        ...
        public StageMapProfile()
        {
            ...
            CreateMap<Stage, StageOutputDto>()
                ...
                // Template/Runtime Permission 1:1 mappings (JSONB string → List<string> for team lists)
                .ForMember(dest => dest.TemplateUseSameAsWorkflow, opt => opt.MapFrom(src => src.TemplateUseSameAsWorkflow))
                .ForMember(dest => dest.RuntimeUseSameAsWorkflow, opt => opt.MapFrom(src => src.RuntimeUseSameAsWorkflow))
                .ForMember(dest => dest.RuntimeViewPermissionMode, opt => opt.MapFrom(src => src.RuntimeViewPermissionMode))
                .ForMember(dest => dest.RuntimeViewTeams, opt => opt.MapFrom(src => DeserializeTeamList(src.RuntimeViewTeams)))
                .ForMember(dest => dest.RuntimeOperateTeams, opt => opt.MapFrom(src => DeserializeTeamList(src.RuntimeOperateTeams)))
                .ForMember(dest => dest.RuntimeUseSameTeamForOperate, opt => opt.MapFrom(src => src.RuntimeUseSameTeamForOperate))
                // Effective Runtime fields are NOT computed here; Service layer fills them manually
            ...
            CreateMap<StageInputDto, Stage>()
                ...
                // Template/Runtime Permission 1:1 mappings (List<string> → JSONB string for team lists)
                .ForMember(dest => dest.TemplateUseSameAsWorkflow, opt => opt.MapFrom(src => src.TemplateUseSameAsWorkflow))
                .ForMember(dest => dest.RuntimeUseSameAsWorkflow, opt => opt.MapFrom(src => src.RuntimeUseSameAsWorkflow))
                .ForMember(dest => dest.RuntimeViewPermissionMode, opt => opt.MapFrom(src => src.RuntimeViewPermissionMode))
                .ForMember(dest => dest.RuntimeViewTeams, opt => opt.MapFrom(src => SerializeTeamList(src.RuntimeViewTeams)))
                .ForMember(dest => dest.RuntimeOperateTeams, opt => opt.MapFrom(src => SerializeTeamList(src.RuntimeOperateTeams)))
                .ForMember(dest => dest.RuntimeUseSameTeamForOperate, opt => opt.MapFrom(src => src.RuntimeUseSameTeamForOperate))
                .ForMember(dest => dest.AttachmentManagementNeeded, opt => opt.MapFrom(src => src.AttachmentManagementNeeded))
