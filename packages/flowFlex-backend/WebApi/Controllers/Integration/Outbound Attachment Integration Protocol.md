# Outbound Attachment Integration Protocol

## Overview

This protocol defines the interface for FlowFlex system to query attachment lists from third-party platforms using System ID.
...
**URL**: `/api/integration/external/v1/outbound-attachments`

**Request Method**: `GET`

**Base URL Example**: `https://your-domain.com/api/integration/external/v1/outbound-attachments`
...
| 404              | ENTITY_NOT_FOUND    | Entity not found      | Check if System ID is correct              |
...
```
GET /api/integration/external/v1/outbound-attachments?SystemId=dcb7fee510a54b93b44617b2dc770e70
```
...
```bash
curl -X GET "https://your-domain.com/api/integration/external/v1/outbound-attachments?SystemId=dcb7fee510a54b93b44617b2dc770e70" \
...
```javascript
fetch(
  "https://your-domain.com/api/integration/external/v1/outbound-attachments?SystemId=dcb7fee510a54b93b44617b2dc770e70",
  {
    method: "GET",
    headers: {
...
- **2025-01-XX**: Initial version release
  - Define outbound attachment list retrieval interface specification
  - Query attachments by System ID
