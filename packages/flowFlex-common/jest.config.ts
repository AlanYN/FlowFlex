...
// 根据项目，加载不同的配置信息
import linc from './configs/linc/dev/base';
...
const config: Config = {
	...
	// cacheDirectory: "C:\\Users\\77432\\AppData\\Local\\Temp\\jest",
	...
	//   "node"
	// ],
	moduleFileExtensions: ['js', 'mjs', 'cjs', 'ts', 'json', 'node', 'vue'],
	...
	moduleNameMapper: {
		...
		'^@routers/(.*)$': '<rootDir>/src/app/routers/$1',
