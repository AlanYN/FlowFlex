...
// const BASE_URL = `${BASE_DOMAIN}permission/index`;
...
onMounted(() => {
	...
	iframeUrl.value = `${settings.idmUrl}/permission/index?appId=${APP_ID}&userId=${userId}&appToken=${token}&theme=${theme}&primary=${primary}`;
});
</script>
