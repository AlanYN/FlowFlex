...
const Api = () => {
	return {
		commentApi: `${globSetting.apiProName}/shared/${globSetting.apiVersion}/comments`,

		updateCommentCount: `${globSetting.apiProName}/activities/${globSetting.apiVersion}/detail`,
	};
};
